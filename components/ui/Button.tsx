...
const variantClasses: Record<Variant, string> = {
  primary:
    'bg-ink text-white hover:bg-sage hover:text-ink border border-ink hover:border-sage',
  secondary: 'bg-sage text-white hover:bg-ink border border-sage hover:border-ink',
  outline:
